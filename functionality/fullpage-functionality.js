...
let siteW = window.innerWidth;
let siteH = window.innerHeight;
let timeLine = new TimelineMax({onComplete:enableHeader});

// Setting the comic-edition on the homepage
const today = new Date();
const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
document.querySelector('div.date').innerHTML = `${months[today.getMonth()]} ${today.getFullYear()} Edition`;
